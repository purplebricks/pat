...
namespace Publisher
{
    internal static class Program
    {
        ...
        {
            var connection = "Endpoint=sb://mailmachinegun-ns.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=RTd/m0LnCjslmIcW1Ez8YB1IYCa4YZ15xZ6axDd3kUs=";
            var topicName = "pat";
